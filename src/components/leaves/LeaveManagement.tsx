...
const LeaveManagement = () => {
  ...
  const [sortConfig, setSortConfig] = useState<any>({ key: 'date_demande', direction: 'desc' });
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      congeData.append('jours_pris', String(diffDays));
      ...
      if (values.jours_conges_annuels) {
        congeData.append('jours_restants', String(values.jours_conges_annuels - diffDays));
      }
